...
> TL;DR: Let AI write the JSX, but you still need to understand the fundamentals—semantic HTML, defaults
> like type="submit", ARIA, and keyboard behavior—if you want your components to be correct and reliable.
