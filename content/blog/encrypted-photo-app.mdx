...
<p align="center">
    <img src="https://user-images.githubusercontent.com/2996493/110783956-176ebe80-828f-11eb-8462-9fad068ac98e.jpg" alt="Estimations" />
</p>
...
Share is a feature which I feel is also very essential for this application.
...
You can check out the web app at [photos.ente.io](https://photos.ente.io/) or can also
checkout the [code](https://github.com/ente-io/bada-frame).
[Android](https://play.google.com/store/apps/details?id=io.ente.photos) and [iOS](https://apps.apple.com/in/app/ente-photos/id1542026904)
apps are also available to play around. 😊