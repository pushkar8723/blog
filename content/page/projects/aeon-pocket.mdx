...
From here on I will refer to him as _My Guy_. So, one day I was going on doing my things. You know sleeping,
eating, and sometimes coding. And _my guy_ pings me and said 'Hey I found a crypto-currency that even you
can mine even on your peasant computer'. So I checked it out. [AEON](https://www.aeon.cash/) was the crypto-currency
he was talking about. A fork of [Monero](https://www.getmonero.org/) but uses [the CryptoNight-Lite](https://en.bitcoinwiki.org/wiki/CryptoNight-Lite)
hashing algorithm so that it can be mined on CPU and doesn't necessarily need a powerful GPU.

### The Challenge

I and _my guy_ explored AEON for a few weeks and came to know about the web wallet bounty and thought 'we can do that!'.
...
Simple enough right? That is what I and _my guy_ thought. But soon realized that the entire codebase was in C++. Which was
slightly out of _my guy's_ domain and completely out of my domain. But we tried fiddling with the code anyway. We found that
...
However, after a month of hard work, we solved the problem and _my guy_ announced the [beta release](https://www.reddit.com/r/Aeon/comments/7qceqa/aeon_pocket_secure_web_wallet_for_aeon/)
...
required the user to resync their wallet from the start of the block. A very heavy transaction for us. Anyway, I and _my guy_
...
While both I and _my guy_ had to do our full-time jobs to pay our bills. Needless to say, whenever any issue happened
someone loses their money and we would be at the receiving end of their anger.
